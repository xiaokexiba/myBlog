...
import com.yeffcc.blog.service.ArticleService;
import com.yeffcc.blog.strategy.context.ArticleImportStrategyContext;
...
import static com.yeffcc.blog.constant.OptTypeConst.*;
...
public class ArticleController {
     ...
     * @return 文章列表
     */
    @ApiOperation(value = "根据条件查询文章列表")
    @GetMapping("/articles/conditionVO")
